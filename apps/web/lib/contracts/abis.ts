...
export const BIDDING_SYSTEM_ABI = parseAbi([
  ...
  'function getRevealedBids(uint256 sessionId) external view returns ((uint256 bidId, address bidder, uint256 proposedAmount, uint256 stake, string message, bytes32 commitHash, bool revealed, bool accepted, bool rejected, bool stakeWithdrawn, uint256 timestamp, uint8 status)[] memory)',
