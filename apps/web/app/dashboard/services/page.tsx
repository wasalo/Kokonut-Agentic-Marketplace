...
import { useProviderStudioServices } from '@/lib/hooks/useProviderStudioServices';
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                {activeServices.map(service => (
                  <ProviderServiceCard key={service.id.toString()} service={service} onRefetch={refetch} />
                ))}
              </div>
            </div>
          )}
