...
import { Plus, Scale, Search, SlidersHorizontal, ChevronLeft, ChevronRight, Loader2, Clock, DollarSign, Users } from 'lucide-react';
        ...
        {showFilters && (
          <div className="mt-4 pt-4 border-t border-divider grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              ...
              <select value={statusFilter} onChange={e => setStatusFilter(e.target.value)} className="w-full px-3 py-2 border border-divider rounded-lg bg-content2 focus:outline-none focus:ring-2 focus:ring-success">
            ...
            <div>
              <label className="text-sm font-medium text-default-500 mb-2 block">Min Reward (ETH)</label>
              <input type="number" placeholder="0" value={minReward} onChange={e => setMinReward(e.target.value)} className="w-full px-3 py-2 border border-divider rounded-lg bg-content2 focus:outline-none focus:ring-2 focus:ring-success" />
            </div>
            <div>
              <label className="text-sm font-medium text-default-500 mb-2 block">Max Reward (ETH)</label>
              <input type="number" placeholder="Any" value={maxReward} onChange={e => setMaxReward(e.target.value)} className="w-full px-3 py-2 border border-divider rounded-lg bg-content2 focus:outline-none focus:ring-2 focus:ring-success" />
            </div>
            <div>
              <label className="text-sm font-medium text-default-500 mb-2 block">Deadline</label>
              <select value={deadlineFilter} onChange={e => setDeadlineFilter(e.target.value)} className="w-full px-3 py-2 border border-divider rounded-lg bg-content2 focus:outline-none focus:ring-2 focus:ring-success">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            onChange={e => { const [newSortBy, newSortOrder] = e.target.value.split('-'); handleSortChange(newSortBy, newSortOrder); }}
