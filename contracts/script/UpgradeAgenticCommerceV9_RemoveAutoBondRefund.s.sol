...
/**
 * @title UpgradeAgenticCommerceV9_RemoveAutoBondRefund
 * @dev Removes auto-refundServiceBond calls on job completion.
 */
contract UpgradeAgenticCommerceV9_RemoveAutoBondRefund is Script {
    ...
    address public constant EXPECTED_CURRENT_IMPLEMENTATION = 0x40b4029dDd11fb0177B28B2d3537B073Da96b0c4;
    ...
    function run() external {
        ...
        console.log("=============================================");
        console.log("AgenticCommerceV9 Remove Auto Bond Refund");
        console.log("=============================================");
        ...
        if (proxy.paused() != false) revert InvalidPostUpgradeState();

        console.log("New Implementation:", address(newImplementation));
        console.log("Auto bond refund removal complete");
    }
